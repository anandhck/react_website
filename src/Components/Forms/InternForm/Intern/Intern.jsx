          ...
          <Form>
            ...
            <div className="f_w">
              ...
              <div className="d-flex justify-content-around mb-3 from_btns">
                ...
                {/* <Link to="/internapply"> */}
                <Button variant="outline-info">NEXT</Button> {/* </Link> */}
              </div>
            </div>
            <div className="vform_text p-2">
              <div className="d-flex">
                <h5>
                  I hereby confirm that the above-given details are accurate and
                  genuine to the best of my knowledge, and I consent to submit
                  them as such for the required purpose.
                </h5>
                {/* <Link to="/"> */}
                <Button variant="outline-info">Confirm</Button> {/* </Link> */}
              </div>
              ...
              <p>
                ...
                this may include, but is not limited to, contacting me regarding
                job vacancies, submitting my details to relevant hiring
                managers, and conducting background checks as necessary.
              </p>
              <br />

              <p>
                I acknowledge that the information provided will be used solely
                for recruitment purposes and will be treated with
