          ...
          <div className="form_intro d-flex justify-content-between align-items-center">
            ...
            <div className="center_box">
              ...
              <div className="v_border_style">
                <h3> Job Title: Back-end Developer</h3>
                ...
                <ol>
                  ...
                  <li>Design and implement data storage solutions.</li>
                  <li>Conduct thorough testing and troubleshooting</li>
                </ol>
                <br />
                ...
                <li>
                  Proficient in server-side programming languages such as
                ...
                <h5>Requirements:</h5>
                <ol>
                  <li>Excellent understanding of web development concepts.</li>
                  <li>Detail-oriented with strong organizational skills.</li>
                  <li>Ability to work collaboratively in a team.</li>
                  <li>
                    Continuously update skills and stay informed about industry
                    trends
                  </li>
                </ol>
                <br />
